...
public class GoogleMapsTestForm1 extends Form implements GoogleStaticMapHandler, CommandListener
{
	Command back;
	...
	public GoogleMapsTestForm1(MIDlet m, Displayable testListScreen)
	{
		super("J2Maps");
